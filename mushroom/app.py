        ...
        try:
            ...
            if self.scd40:
                if self.scd40.data_ready:
                    ...
                    print("⚠️ SCD40 data not ready")
            else:
                print("⚠️ SCD40 not available")
            ...
            if self.water_sensor:
                ...
                if distance is not None:
                    ...
                    print("⚠️ Ultrasonic reading failed")
            else:
                print("⚠️ Ultrasonic sensor not available")
